...
export const createOrder = (payload) => {
    return jwtAxios.post(`${prefix}/orders`, payload);
};
...
export const getOrderDetail = async (orderId) => {
    const response = await jwtAxios.get(`${prefix}/orders/list/${orderId}`);
    return response.data;
};

// ✅ 주문 취소
export const cancelMyOrder = async (orderId) => {
    return jwtAxios.patch(`${prefix}/orders/${orderId}/cancel`);
};
