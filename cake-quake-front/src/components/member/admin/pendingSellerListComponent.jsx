                ...
                {data?.content?.map((pending) => (
                    <div key={pending.tempSellerId} className="border-b p-2">
                        ...
                        <div className="flex items-center space-x-2">
                            <button className="bg-green-500 text-white px-3 py-1 rounded-full text-sm flex items-center space-x-1 shadow-sm hover:bg-green-800 transition-colors duration-200">
                                <span>승인</span>
                            </button>
