...
function OptionAdd({
    ...
    return (
        <div className="max-w-xl mx-auto my-10 p-8 bg-white rounded-lg font-sans">
                        ...
                        <div key={index} className="flex items-center gap-3 mb-3">
                            {optionItems.length > 1 && (
                                <button
                                    ...
                                    className="w-6 h-6 flex items-center justify-center border border-gray-300 rounded-full text-xs text-gray-500 hover:bg-gray-100 hover:text-gray-500 transition duration-200"
                                    title="옵션 제거"
                                >
                                    &minus;
                                </button>
                            ...
                            />
                            <span className="text-base text-gray-600 min-w-[25px] text-center">원</span>
                        </div>
                    ))}
